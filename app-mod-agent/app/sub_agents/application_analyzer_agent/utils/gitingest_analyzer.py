...
class GitingestAnalyzer(CodebaseAnalyzer):
    async def _load_codebase_text(self, secure_temp_repo_dir: str) -> str:
        """
    ...
    async def analyze(self, secure_temp_repo_dir: str, prompt: str, model_name: str) -> str:
        ...
        """
        full_codebase_text = await self._load_codebase_text(secure_temp_repo_dir)
